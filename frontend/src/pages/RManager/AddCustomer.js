    ...
    <div className="restaurant-manager">
      ...
      <div className="sidebar">
        <ul className="sidebar-menu">
          ...
          <li className={activeMenu === 'Category' ? 'active' : ''}>
            <button onClick={() => handleMenuClick('/Rcategory')}>Category</button>
          </li>
          ...
          <li className={activeMenu === 'Restaurants' ? 'active' : ''}>
            ...
            {activeMenu === 'Restaurants' && (
              <div className="submenu">
                ...
                <button onClick={() => navigate("/EditRestaurant")}>Edit Restaurant</button>
            </div>
            )}
          </li>
      ...
      <div className="add-customer-container">
            ...
            <form onSubmit={handleSubmit} className="form-grid">
                ...
                <textarea id="textarea" name="address" rows="8" cols="150" value={customer.address}
